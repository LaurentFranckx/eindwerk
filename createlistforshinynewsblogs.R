...
CreateCorpusList <- function(corpusnames, strglthlist){
  ...
  for(corpus in corpusnames){
    for(strgtgth in strglthlist){
      ...
      #if(strgtgth == 4 ){
        searchcorpus$ML1 <- searchcorpus$ML1[searchcorpus$ML1$freq > 2  , ]
        searchcorpus$ML2 <- searchcorpus$ML1[searchcorpus$ML2$freq > 2  , ]
        searchcorpus$ML3 <- searchcorpus$ML1[searchcorpus$ML3$freq > 2  , ]
