...
names(head_table) <- c("# of words in twitter", "# of words in twitter", "# of words in twitter", "# of counts")
knitr::kable(head_table, caption = "Low frequency words")

tail_table <- tail_table[ , c(1,2,4,6)]
names(tail_table) <- c("# of counts", "# of words in twitter", "# of words in twitter", "# of words in twitter" )
